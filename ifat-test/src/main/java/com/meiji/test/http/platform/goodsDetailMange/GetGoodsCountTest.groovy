package com.meiji.test.http.platform.goodsDetailMange

import com.meiji.biz.request.http.platform.goodsDetailManage.AddRecord
import com.meiji.biz.request.http.platform.goodsDetailManage.GetGoodsCount
