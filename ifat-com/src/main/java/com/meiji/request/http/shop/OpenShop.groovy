...
class OpenShop extends MeijiRequest {
    {
        super.api = "/shop/openShop"
        super.params =  [ "companyCode","companyCodeType","companyName","legalPersonName","legalPersonWechat","shopType"]
