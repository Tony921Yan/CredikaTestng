package com.meiji.biz.request.http.shop.goods
...
class UpdateShopGoodsStates extends ShopPost {
    {
        super.api = "/shop/goods/updateShopGoodsStates"
        super.params =  [ "shopId","state","supIdList"]
