package com.credika.biz.request.http.shop.module
...
class UpdateShopModule extends ShopPost {
    {
        super.api = "/shop/module/updateShopModule"
        super.params =  [ "description","displayContent","id","moduleType","shopId","sort","targetContent","targetType","title"]
