...
import com.meiji.biz.request.http.platform.activeMainManage.giftManage.CategoryDetail
import com.meiji.biz.request.http.platform.activeMainManage.giftManage.EditCategory
